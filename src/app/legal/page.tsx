...
export default function LegalPage() {
  ...
  if (lang === 'en') return (
    <main className="max-w-3xl mx-auto px-4 py-12">
      ...
      <p className="text-sm text-gray-500 mb-8">This page is required under Japan's Act on Specified Commercial Transactions for paid services offered to users in Japan.</p>
      <table className="w-full text-sm border-collapse">
        <tbody>
          {[
            ['Service Name', 'Simple Invoice Maker'],
            ...
            ['Cancellation Policy', 'Subscriptions can be cancelled anytime from account settings. No refunds for current billing period.'],
          ].map(([k, v]) => (
